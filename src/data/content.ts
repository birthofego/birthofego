...
export const content: Content = {
  ...
  about2: {
    ...
    p7: "While I wish I took GitHub history and conserving my projects more seriously, there’s nothing I can do now except be cautious and hold onto my builds going forward. I’m eagerly looking to land my first software developer position. I grew up teaching myself through those crazy long 12 hour tutorials, chopping 24 hour videos across days, building projects and gamified examples just to make things stick — all while balancing work and paying for Codecademy subscriptions out of pocket. That discipline means AI only sharpens my edge. Something I can ask infinite questions no matter how specific, and get answers instantly instead of scrubbing through a 6 hour video. It’s a tool, never a substitute for skill — unless my employer specifically asks me to lean on it.",
